...
@interface BossSound1SucViewController ()<AVAudioPlayerDelegate>
{
    AVPlayer *player;
}
@end
...
-(void)playav
{
    NSString *path = [[NSBundle mainBundle] pathForResource:@"BOSE_4 真实音效 结束" ofType:@"wav"];
    // (2)把音频文件转化成url格式
...
-(void)jieshu
{
    [DEF_UserDefaults setObject:@"1" forKey:@"1112"];
