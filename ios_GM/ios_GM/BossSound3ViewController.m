...
@interface BossSound3ViewController ()<CBCentralManagerDelegate,AVAudioPlayerDelegate,UIAlertViewDelegate>
{
    AVPlayer *player;
}
...
@implementation BossSound3ViewController
...
- (void)viewDidLoad {
    ...
    LOTAnimationView *animation = [LOTAnimationView animationNamed:@"high"];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if ([btnTitle isEqualToString:@"确定"]) {
        [player pause];
        BossSound3BeginViewController *vc = [[BossSound3BeginViewController alloc]init];
